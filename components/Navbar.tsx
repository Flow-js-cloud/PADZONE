...
export function Navbar({ onSearchOpen }: NavbarProps) {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
              ...
              >
                ...
                {openDropdown === link.label && (
                  <motion.div
                    ...
                    className="absolute top-full left-0 mt-1 w-52 glass border border-border rounded-lg overflow-hidden"
                    onMouseEnter={() => openMenu(link.label)}
                    onMouseLeave={closeMenu}
                  >
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              {itemCount > 0 && (
                <motion.span
                  ...
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  className="cart-count absolute -top-1 -right-1 w-5 h-5 rounded-full text-xs font-orbitron font-bold text-white flex items-center justify-center"
                >
            ...
            {/* User — icône sur mobile, texte sur desktop */}
            {user ? (
              <>
                <Link
                  href="/compte"
      ...
      {/* Mobile menu — hors du header pour éviter le containing block du backdrop-filter */}
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="lg:hidden fixed top-16 left-0 right-0 bottom-0 flex flex-col border-t border-border overflow-hidden"
          ...
          >
            ...
            {/* Boutons connexion fixés en bas */}
