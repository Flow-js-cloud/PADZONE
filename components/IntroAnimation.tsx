  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-6 px-8 text-center select-none">
              ...
              <span key={i} className="intro-anim font-orbitron font-black"
                style={{
                  ...
                  textShadow: isPad
                    ...
                    : "0 0 30px #ff0066, 0 0 60px rgba(255,0,102,0.4)",
                  animation: isPad
                    ? `intro-down 0.35s cubic-bezier(0.34,1.56,0.64,1) ${0.2 + i * 0.06}s both`
                    : `intro-up 0.35s cubic-bezier(0.34,1.56,0.64,1) ${0.2 + i * 0.06}s both`,
                }}>
                {l}
              </span>
            );
        ...
        {/* Underline */}
        <div className="w-48 h-0.5 overflow-hidden mx-auto">
          <div className="intro-anim h-full"
            style={{ background: "linear-gradient(90deg,#00e5ff,#ff0066)", animation: "intro-width 0.5s ease 0.7s both" }} />
        </div>
        ...
        {/* Loader */}
        <div className="intro-anim w-48 h-0.5 bg-white/10 relative overflow-hidden rounded-full mx-auto"
          style={{ animation: "fade-in 0.3s ease 1.0s both" }}>
          <div className="intro-anim absolute inset-y-0 left-0 rounded-full"
            style={{ background: "linear-gradient(90deg,#00e5ff,#ff0066)", animation: "intro-width 0.7s linear 1.1s both" }} />
        </div>

        {/* Button */}
        <button
          className="intro-anim px-8 py-3 font-orbitron font-bold text-sm tracking-[0.2em] uppercase border transition-colors duration-200 hover:bg-cyan-DEFAULT/10"
